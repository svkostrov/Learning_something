...
nameforlook = r"[0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-][0-9a-zA-Z_-]\w+.\w\wg"
fullurl = re.findall(textlookfor, str(otvet))
nameimg = re.findall(nameforlook, str(otvet))

print("Имя картинки: ", nameimg[0])
